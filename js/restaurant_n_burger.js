...
function renderRestaurantVenue(key) {
  ...
  panel.innerHTML = '<section class="venue_content venue_content_' + key + '" aria-labelledby="venue_title"><div class="page_container">' +
    ...
    '<div class="venue_intro_body"><h2 id="venue_title">' + escapeRestaurantText(venue.title) + '</h2><p class="venue_meta"><span>' + escapeRestaurantText(venue.floor) + '</span><i aria-hidden="true">|</i><span>' + escapeRestaurantText(venue.hours) + '</span></p><p class="venue_description">' + escapeRestaurantText(venue.description) + '</p><div class="venue_info_grid">' + infoMarkup + '</div><a class="venue_reserve_button" href="https://naver.me/xGIPHFHB" target="_blank" rel="noopener noreferrer">Go to Reservation App</a></div></div>' +
